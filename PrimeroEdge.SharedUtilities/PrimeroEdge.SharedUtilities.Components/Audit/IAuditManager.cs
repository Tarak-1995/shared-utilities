...
namespace PrimeroEdge.SharedUtilities.Components
{
    ...
    public interface IAuditManager
    {
        ...
        /// <param name="regionId"></param>
        /// <returns></returns>
        Task<List<AuditV1Response>> GetAuditDataV1Async(string moduleId, string entityTypeId, string entityId, int pageSize, int pageNumber, int regionId);
        ...
        /// <param name="updatedOn">updatedOn.</param>
        /// <returns></returns>
        Task<List<AuditV1Response>> GetAuditDataSearchV1Async(string moduleId, string entityTypeId, string entityId,
            int pageSize, int pageNumber, int regionId, string fieldName, string updatedBy, DateTime? updatedOn);
